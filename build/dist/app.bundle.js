...
var component_types = [_Alert2.default, _Badge2.default, _Breadcrumb2.default, _Tab2.default, _Panel2.default, _Form2.default, _FormInput2.default];
...
var Alert = function (_Base) {
	_inherits(Alert, _Base);

	function Alert(selector, index) {
		_classCallCheck(this, Alert);

		var _this = _possibleConstructorReturn(this, (Alert.__proto__ || Object.getPrototypeOf(Alert)).call(this, selector, index));

		_this.alertContent = function () {
...
var Badge = function (_Base) {
     ...
     * @param index
     */
    function Badge(selector, index) {
        _classCallCheck(this, Badge);

        var _this = _possibleConstructorReturn(this, (Badge.__proto__ || Object.getPrototypeOf(Badge)).call(this, selector, index));

        _this.badgeContent = function () {
            // get content of badge
            return $(this.selector).html();
        };

        _this.badgePill = function () {
            // get content of badge
            return $(this.selector).attr('pill');
        };

        _this.badgeType = function () {
            // get type of badge
...
**/
var Breadcrumb = function (_Base) {
	_inherits(Breadcrumb, _Base);

	function Breadcrumb(selector, index) {
		_classCallCheck(this, Breadcrumb);

		var _this = _possibleConstructorReturn(this, (Breadcrumb.__proto__ || Object.getPrototypeOf(Breadcrumb)).call(this, selector, index));

		_this.BreadcrumbItem = function (itemIndex, active, content) {
			this.itemIndex = itemIndex;
			this.active = active;
			this.content = content;
